...
public interface OnSwipeMenuItemClickListener {
     ...
     * @param direction       can be {@link SwipeConstants#LEFT_DIRECTION}, {@link SwipeConstants#RIGHT_DIRECTION}.
     */
    void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, @SwipeConstants.DirectionMode int direction);
